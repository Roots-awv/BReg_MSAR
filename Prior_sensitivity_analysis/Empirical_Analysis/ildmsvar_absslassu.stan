...
transformed parameters {
  ...
  real beta_x = beta_[1] *sigma_u;
  vector[5] beta_evt = beta_[2:6]*sigma_u; 
  vector[3] beta_y= beta_[7:9]*sigma_u;
  vector[3] beta_xy= beta_[10:12]*sigma_u;
  vector[5] beta_evty1= beta_[13:17]*sigma_u;
  vector[5] beta_evty2= beta_[18:22]*sigma_u;
  vector[5] beta_evty3= beta_[23:27]*sigma_u;
